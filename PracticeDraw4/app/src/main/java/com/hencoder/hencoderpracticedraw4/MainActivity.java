...
public class MainActivity extends AppCompatActivity {
...

    {
        ...
        pageModels.add(new PageModel(R.layout.sample_rotate, R.string.title_rotate, R.layout.practice_scale));
        pageModels.add(new PageModel(R.layout.sample_scale, R.string.title_scale, R.layout.practice_rotate));
